...
export const useSwapUsdtToXee = () => {
    ...
    // Read USDT balance
    const { data: usdtBalanceData, isLoading: isUsdtBalanceLoading, isError: isUsdtBalanceError } = useReadContract({
    ...
    const approveUsdt = async (amount: bigint): Promise<Address> => {
        ...
        try {
            ...
            setStatus('idle');
            setError(error instanceof Error ? error : new Error('USDT approval failed'));
            throw error;
        }
    };
...
export const useSwapXeeToUsdt = () => {
    ...
    const approveXee = async (amount: bigint): Promise<Address> => {
        ...
        try {
            ...
            setStatus('idle');
            setError(error instanceof Error ? error : new Error('XEE approval failed'));
            throw error;
        }
    };
